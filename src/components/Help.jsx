...
export default () => {
    return (
        <>
            <div className="pad">
                <h2>Help</h2>
                <p>The aim of this game is to hover (for PCs) on the coloured squares (like <img src={images.good} height="20px" width="20px"></img> ) Or tap (for mobile devices) on them to get 1 point.
